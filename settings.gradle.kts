...
include(":di-bootstrap-bridge")
include(":serviceevents-bootstrap-bridge")
...
include(":instrumentation:serviceevents")
include(":otelagent")
...
// ServiceEvents contract-test image (used by appsignals-tests:contract-tests)
include("appsignals-tests:images:serviceevents:spring-mvc-serviceevents")
