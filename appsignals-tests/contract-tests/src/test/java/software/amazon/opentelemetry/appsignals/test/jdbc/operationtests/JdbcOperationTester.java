...
public abstract class JdbcOperationTester {
  ...
  public void assertAwsSpanAttributes(
      List<ResourceScopeSpan> resourceScopeSpans,
      String method,
      String path,
      String type,
      String identifier,
      String applicationOtelServiceName) {
        ...
        assertThat(attributesList)
            ...
            .satisfiesOnlyOnce(
                attribute -> {
                  ...
                  assertThat(attribute.getValue().getStringValue())
                      .isEqualTo(applicationOtelServiceName);
                })
            .satisfiesOnlyOnce(
                attribute -> {
  ...
  public void assertSemanticConventionsSpanAttributes(
      List<ResourceScopeSpan> resourceScopeSpans, String otelStatusCode) {
    assertThat(resourceScopeSpans)
        .satisfiesOnlyOnce(
            rss -> {
  ...
  public void assertMetricAttributes(
