...
package software.amazon.distro.opentelemetry.cloudwatch.spanmetrics.e2e.base;
...
import software.amazon.distro.opentelemetry.cloudwatch.spanmetrics.e2e.SpanMetricsAssertions;
import software.amazon.distro.opentelemetry.cloudwatch.spanmetrics.e2e.utils.MockCollectorClient;
 ...
 *   <li>A mock-collector container ({@code cloudwatch-plugin-otel-mock-collector}) that receives the
...
public abstract class SpanMetricsContractTestBase {
  ...
  protected static final String EXTENSION_MOUNT_PATH = "/cloudwatch-plugin-otel.jar";
  ...
  protected final GenericContainer<?> mockCollector =
      new GenericContainer<>("cloudwatch-plugin-otel-mock-collector")
