...
import static software.amazon.opentelemetry.cloudwatch.spanmetrics.e2e.SpanMetricsAssertions.DURATION_METRIC;
import static software.amazon.opentelemetry.cloudwatch.spanmetrics.e2e.SpanMetricsAssertions.assertScope;
import static software.amazon.opentelemetry.cloudwatch.spanmetrics.e2e.SpanMetricsAssertions.attributeEquals;
import static software.amazon.opentelemetry.cloudwatch.spanmetrics.e2e.SpanMetricsAssertions.callsDataPoint;
import static software.amazon.opentelemetry.cloudwatch.spanmetrics.e2e.SpanMetricsAssertions.callsValue;
import static software.amazon.opentelemetry.cloudwatch.spanmetrics.e2e.SpanMetricsAssertions.stringAttributes;

import java.util.List;
import java.util.Map;
import java.util.Set;
import org.junit.jupiter.api.Test;
import software.amazon.opentelemetry.cloudwatch.spanmetrics.e2e.base.SpanMetricsContractTestBase;
import software.amazon.opentelemetry.cloudwatch.spanmetrics.e2e.utils.ResourceScopeMetric;
import software.amazon.opentelemetry.cloudwatch.spanmetrics.e2e.utils.ResourceScopeSpan;
